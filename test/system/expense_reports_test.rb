...
class ExpenseReportsTest < ApplicationSystemTestCase
  ...
  test "should create expense report" do
    ...
    fill_in "Amount", with: @expense_report.amount
    fill_in "Category", with: @expense_report.category
    fill_in "Date", with: @expense_report.date
    fill_in "Description", with: @expense_report.description
